    ...
    <header className="bg-gray-800 text-white p-4 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className=" space-x-4 text-sm text-gray-400 mt-2 mx-4">
          ...
          <span className="cursor-pointer text-lg font-bold  hover:text-white hover:border-b-2" onClick={handleHomePage}>
            Home
            </span>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="flex items-center bg-white text-[#111] font-semibold py-2 px-3 rounded-md hover:bg-gray-200 transition-colors whitespace-nowrap" onClick={handleCreateStack}>
